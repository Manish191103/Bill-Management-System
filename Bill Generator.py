...
class Bill_App:
    def __init__(self,root):
        ...
        #==================Cosmetics Frame=====================#
        F2 = LabelFrame(self.root,text = 'Cosmetics (Per piece)',bd = 10,relief = GROOVE,bg = bg_color,fg = "yellow",font = ("times new roman",13,"bold"))
        ...
        #==================Grocery Frame=====================#
        F2 = LabelFrame(self.root,text = 'Grocery (Kg)',bd = 10,relief = GROOVE,bg = bg_color,fg = "yellow",font = ("times new roman",13,"bold"))
        ...
        F2 = LabelFrame(self.root,text = 'Other',bd = 10,relief = GROOVE,bg = bg_color,fg = "yellow",font = ("times new roman",13,"bold"))
        ...
        #========Aalu Bhujia
        bhujia_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Aalu bhujia")
        bhujia_lbl.grid(row = 3,column = 0,padx = 10,pady = 20)
        bhujia_en = Entry(F2,bd = 8,relief = GROOVE,textvariable = self.nimko)
        bhujia_en.grid(row = 3,column = 1,ipady = 5,ipadx = 5)
